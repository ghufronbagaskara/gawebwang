    ...
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
        ...
        @if ($walletTransaction->type == 'Topup')
          ...
          <a href="{{ Storage::url($walletTransaction->proof) }}" target="_blank">
            <img
              src="{{ Storage::url($walletTransaction->proof) }}"
              class="rounded-2xl max-w-full h-auto mb-3 cursor-pointer hover:opacity-80 transition">
          </a>
          @if (!$walletTransaction->is_paid)
            <hr class="my-5">
