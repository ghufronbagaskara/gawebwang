    ...
    <section id="details"
      ...
      <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px]">
        ...
        <div class="flex flex-col gap-1">
          ...
          <p class="text-sm text-[#545768]">
            Posted at {{ $project->created_at->format('d F Y') }}
          </p>
        </div>
        ...
        <div class="w-full bg-[#0FB848] flex items-center gap-[10px] p-[10px_14px] rounded-xl">
          ...
          <p class="text-white font-semibold text-sm">
            This project is worldwide means that you can apply and working from wherever you are.
          </p>
        </div>
      ...
      <div class="flex flex-col sm:w-[300px] h-fit shrink-0 bg-white rounded-[20px] p-5 gap-[30px]">
        ...
        <div class="flex flex-col gap-3">
          @auth
            @if (Auth::user()->hasAppliedToProject($project->id))
              <a href="{{ route('dashboard.proposals', $project->slug) }}"
                class="bg-[#6635F1] p-[14px_20px] rounded-full font-semibold text-white text-center">
                View Proposal
              </a>
            @else
          ...
          @guest
            @if (!$project->has_started && !$project->has_finished)
              <a href="{{ route('login') }}"
                class="bg-[#6635F1] p-[14px_20px] rounded-full font-semibold text-white text-center">
                Apply Now
              </a>
          ...
          <a href=""
            class="bg-[#030303] p-[14px_20px] rounded-full font-semibold text-white text-center">
            Bookmark Job
          </a>
        </div>
        ...
        <a href=""
          class="font-semibold border border-[#030303] p-[14px_20px] rounded-full text-center">
          Report this Job
        </a>
