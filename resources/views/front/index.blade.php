...
@section('content')
  ...
  <body class="font-poppins text-[#030303] bg-[#F6F5FA] pb-[100px] px-4 sm:px-0">
    ...
    <section id="header"
      ...
      <h1 class="font-extrabold text-[40px] leading-[45px] text-center sm:text-left">Browse Your <br>Favorites Projects
      </h1>
    ...
    <section id="newest"
      class="container max-w-[1130px] mx-auto flex flex-col sm:flex-row sm:flex-nowrap items-start gap-5 mt-[50px]">
          ...
          <div class="flex flex-col gap-[10px] rounded-[20px] p-[10px_14px] bg-[#030303]">
            <div class="flex items-center gap-3">
              ...
              <p class="text-sm text-white">You have <span class="font-bold">{{ Auth::user()->connect }}</span>
                connects available to get a new
                job</p>
            </div>
