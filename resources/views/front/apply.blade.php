  ...
  <body class="font-poppins text-[#030303] bg-[#F6F5FA] pb-[100px] px-4 sm:px-0">
    ...
    <section id="details"
      ...
      <div class="flex flex-col gap-5">
        <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px] h-fit">
          <div class="w-full bg-[#0FB848] flex items-center gap-[10px] p-[10px_14px] rounded-xl">
            ...
            <p class="text-white font-semibold text-sm">This project is worldwide means that you can apply and working
        ...
        <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px] h-fit">
          ...
          <div class="w-full bg-[#030303] flex items-center gap-[10px] p-[10px_14px] rounded-xl">
            ...
            <p class="text-white font-normal text-sm"><span class="font-bold">1 connect</span> will be deducted from your
              account to apply this job</p>
          </div>
          ...
          <form action="{{ route('front.apply_job.store', $project) }}" method="POST" class="flex flex-col gap-5">
            ...
            <div class="flex flex-col sm:flex-row gap-3 items-center">
              <button class="font-semibold bg-[#030303] p-[14px_20px] rounded-full text-center w-full text-white">
                Save as a Draft
              </button>
              <button type="submit"
                class="font-semibold bg-[#6635F1] p-[14px_20px] rounded-full text-center w-full text-white">
                Apply Now
              </button>
            </div>
          </form>
      ...
      <div class="flex flex-col sm:w-[300px] h-fit shrink-0 bg-white rounded-[20px] p-5 gap-[30px]">
        <div class="flex flex-col gap-3">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col gap-[2px]">
              ...
              <p class="text-sm leading-[21px] text-[#545768]">{{ $project->owner->projects->count() }} Total Projects
              </p>
            </div>
          </div>
        ...
        <hr>
        <a href="" class="font-semibold border border-[#030303] p-[14px_20px] rounded-full text-center">Report
          this Job</a>
      </div>
    </section>
  </body>
